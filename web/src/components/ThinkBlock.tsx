  ...
  return (
    <div className="my-1 w-full min-w-0">
      <button onClick={() => setOpen(!open)}
        className="inline-flex max-w-full items-center gap-1.5 whitespace-nowrap text-[11px] text-amber-600 bg-amber-50 hover:bg-amber-100 border border-amber-200 rounded-full px-3 py-0.5 transition-colors">
